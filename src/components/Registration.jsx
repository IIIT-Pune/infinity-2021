...
function Registration({ SetisSuccessfull }) {
	...
	return (
		<div className="h-screen px-16 py-12 flex justify-center ">
			<div className=" h-full max-w-4xl flex flex-row rounded-lg overflow-hidden">
				<div className="w-1/2 h-full text-sm font-squidgame bg-gradient-to-br from-pink-squid  to-pink-400  py-2 items-center flex flex-col space-y-2">
				...
				<div className="bg-gray-900 h-full w-1/2 cursor-pointer">
					<video
